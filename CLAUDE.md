# Claude Code Instructions for the Taco Bell 50k Project

Welcome to the **Taco Bell 50k** React application! This file provides context and guidelines for working with this codebase.
...
- Avoid unnecessary complexity. When planning, consider if a simpler approach is adequate in carrying out a task.
